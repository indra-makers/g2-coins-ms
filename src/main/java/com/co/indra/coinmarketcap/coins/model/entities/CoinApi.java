...
public class CoinApi implements Serializable {
    ...
    public CoinApi(String id, int rank, String symbol, String name, Double supply, Double maxSupply, Double marketCapUsd, Double volumeUsd24Hr, Double priceUsd, Double changePercent24Hr, Double vwap24Hr, String explorer) {
        this.id = id;
        this.rank = rank;
        this.symbol = symbol;
        this.name = name;
